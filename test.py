...
def run_sample():
    try:
        ...
        block_blob_service = BlockBlobService(account_name='sudhakar', account_key='6H/W6gs2TNmYRaFRGWsdB4HHIg1ApZvcEiZa+6CsCBndnRDH/eHHqKeqcMb/6HQ1xCOGsqvZ9A+pFMFesJ9Q9w==')

        # Create a container called 'net'.
        container_name ='nodeblob'

        # Set the permission so the blobs are public.
        block_blob_service.set_container_acl(container_name, public_access=PublicAccess.Container)

        # Create a file in Documents to test the upload and download.
        local_path=os.path.expanduser("G:\cloud")
        local_file_name ="jawa.txt"
